...
|---|---:|---|
| Active Markdown documents | 43 | Repository root, `.cursor/`, `.github/`, `docs/`, and active `audit/` records |
| Archived Markdown documents | 22 | `docs/archive/legacy/` |
| Active implementation source of truth | 1 | `README.md` |
...
The active README now describes the owner-confirmed external-merchant comparison and post-confirmation reward-points direction, the API-pending development policy, the source-agnostic catalog foundation, current validation commands, and the staging/production boundary. It does not claim that partner APIs, price feeds, merchant permissions, settlement terms, vouchers, gifts, or production readiness are available.
