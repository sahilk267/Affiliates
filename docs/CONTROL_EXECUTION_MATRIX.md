...
| Financial/auth/API/catalog feature suite | PHPUnit | Passed; 19 tests, 91 assertions |
...
| API-independent catalog/comparison preview | `product_price_snapshots` migration, snapshot service, ranking service, generic adapter boundary, guarded fixture seeder, and local feature tests | Passed locally; synthetic data only, no external partner data or reward activation |
