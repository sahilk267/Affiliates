...
The smoke harness remained mutation-safe by default. No real partner credentials, live payout operations, or production systems were used. Later catalog-foundation tests also use only local fixtures; they do not establish partner API capability.
