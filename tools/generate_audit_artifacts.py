...
write_md('documentation.md', f'''# Documentation Audit\n\nThe repository contains {len(active_markdown_files)} active Markdown files and {len(archived_markdown_files)} archived Markdown files. Active and archived documentation are classified in `audit/documentation.md` and `docs/archive/README.md`; archived files are historical and must not be treated as current instructions or evidence.\n''')
